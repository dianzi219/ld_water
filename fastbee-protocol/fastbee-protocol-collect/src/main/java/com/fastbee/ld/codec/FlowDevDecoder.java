...
import com.fastbee.ld.model.FlowDevParser;
...
public class FlowDevDecoder {
    ...
    public FlowDev decode(DeviceData deviceData, ExplainUtils explain){
        ...
        flowDev.setInstant(FlowDevParser.parseInstant(flowDev.getInstant()));
        flowDev.setSum(FlowDevParser.parseSum(flowDev.getSum()));
        flowDev.setTs(FlowDevParser.parseTs(flowDev.getTs()));
